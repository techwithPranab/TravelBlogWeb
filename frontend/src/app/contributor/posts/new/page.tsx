...
export default function NewPostPage() {
  ...
  const handleSubmit = async (e: React.FormEvent, status: 'draft' | 'pending' | 'inactive') => {
    e.preventDefault()
    setLoading(true)
    ...
    try {
      ...
      await contributorApi.createPost(postData)
      const statusMessage = status === 'pending' ? 'submitted for review' : status === 'inactive' ? 'saved as inactive' : 'saved as draft'
