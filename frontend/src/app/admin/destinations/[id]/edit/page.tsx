...
export default function EditDestinationPage() {
  ...
  const loadDestination = async () => {
    try {
      ...
      setFormData({
        ...
        featuredImage: destination.featuredImage || { url: '', alt: '' },
        gallery: destination.gallery || [],
        bestTimeToVisit: destination.bestTimeToVisit || '',
        averageTemperature: destination.averageTemperature || { summer: '', winter: '' },
        ...
        relatedPosts: destination.relatedPosts || [],
      ...
      setAccommodation(destination.accommodation || [])
      
      setLocalCuisine(destination.localCuisine || [])
      setTravelTips(destination.travelTips || [])
    } catch (error) {
  ...
  const handleFeaturedImageUpload = async (file: File) => {
    ...
    try {
      ...
      const response = await adminApi.uploadDestinationImage(formData)
