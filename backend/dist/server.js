...
app.get('/api/public/travel-locations', async (req, res) => {
    try {
        ...
        const travelLocations = Array.from(locationMap.values()).map((location) => ({
            ...location,
