...
exports.getProfanityError = getProfanityError;
...
function containsProfanity(text) {
    ...
    const hasWhitelistedContext = WHITELIST_CONTEXTS.some(context => lowerText.includes(context.toLowerCase()));
    ...
    return INAPPROPRIATE_WORDS.some(word => {
        ...
        if (travelSafeWords.includes(word) && (lowerText.includes('travel') ||
