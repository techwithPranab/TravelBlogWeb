...
const testWeatherService = async () => {
    ...
    try {
        ...
        const coordinates = await weatherService_1.default.getCoordinates('Paris, France');
        if (coordinates) {
        ...
        const weatherData = await weatherService_1.default.getWeatherForecast(coordinates.lat, coordinates.lng, startDate, endDate);
