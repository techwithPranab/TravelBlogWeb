...
exports.testEmailIntegration = testEmailIntegration;
...
async function testEmailIntegration() {
    ...
    try {
        ...
        if (typeof emailService_1.emailService.sendPhotoSubmissionNotificationToAdmin === 'function') {
        ...
        if (typeof emailService_1.emailService.sendPhotoApprovalNotification === 'function') {
